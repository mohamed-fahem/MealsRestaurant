        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubscriptionPrice = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NumberMeal = table.Column<int>(type: "int", nullable: false),
                    SubscriptionImage = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MealPriceDiscount = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MealSubscriptions_Meals_MealId",
                        column: x => x.MealId,
                        principalTable: "Meals",
                        principalColumn: "MealId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MealSubscriptions_Subscriptions_SubscriptionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealSubscriptions_MealId",
                table: "MealSubscriptions",
                column: "MealId");

            migrationBuilder.CreateIndex(
                name: "IX_MealSubscriptions_SubscriptionId",
                table: "MealSubscriptions",
